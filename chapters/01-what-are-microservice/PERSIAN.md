...
#### ۳. داشتن دیتابیس اختصاصی

در سیستم‌های قدیمی همه‌ی بخش‌ها به یک دیتابیس بزرگ متصل می‌شدن. این کار مثل این است که همه‌ی کارمندان رستوران کارت بانکی اصلی رستوران رو تو جیب خودشون داشته باشن.

در میکروسرویس هر بخش دیتابیس مخصوص خودش رو داره. اگر سرویس پروفایل داده‌ای از سرویس سفارشات بخواد، باید مؤدبانه ازش درخواست کنه، نه این که سرش رو عین گاو بندازه پایین و بره سراغ دیتابیس اون سرویس.

---

### قانون Conway

این قانون یک نکته‌ی روان‌شناختی و جالب داره که می‌گه:

> سیستمی که طراحی می‌کنید، دقیقاً شبیه به ساختار ارتباطی شرکت شما خواهد شد.

اگر شرکت شما به‌صورت افقی و لایه‌ای اداره می‌شه (یک تیم فرانت، یک تیم بک‌اند و یک تیم دیتابیس)، نرم‌افزار شما هم ناخودآگاه سه‌لایه و پیچیده می‌شه و برای هر فیچر جدید باید بین هر 3 تیم هماهنگی انجام بشه.

ولی اگر به‌صورت عمودی سازمان‌دهی کنی (تیم‌های کوچک همه‌فن‌حریف که هر یک مسئول یک بخش هستن)، برنامه‌ی شما هم به‌طور طبیعی به میکروسرویس‌های کارآمد و مستقل تبدیل می‌شه.

> **حواسمون باشه که داشتن 100 بخش مستقل در رستوران هزینه‌ی هماهنگی و مدیریتی بالاتری داره. پس باید این مسیر رو آرام‌آرام و پله‌پله طی کنیم.**
